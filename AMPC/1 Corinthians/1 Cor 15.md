...
And last of all He appeared to me also, as to one prematurely _and_ born dead [no better than an unperfected fetus among living men]. 
...
And just as we have borne the image [of the man] of dust, so shall we _and so_ _let us_ also bear the image [of the Man] of heaven. 
...
And when this perishable puts on the imperishable and this that was capable of dying puts on freedom from death, then shall be fulfilled the Scripture that says, Death is swallowed up (utterly vanquished forever) in _and_ unto victory. 

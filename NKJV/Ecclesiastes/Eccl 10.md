...
###### 1 
Dead[^a] flies [^b]putrefy the perfumer's ointment, And cause it to give off a foul odor; _So does_ a little folly to one respected for wisdom _and_ honor. 
...
###### 4 
If the spirit of the ruler rises against you, Do not leave your post; For conciliation[^c] pacifies great offenses. 

###### 5 
There is an evil I have seen under the sun, As an error proceeding from the ruler: 

###### 6 
Folly is set in [^d]great dignity, While the rich sit in a lowly place. 
...
###### 11 
A serpent may bite when _it is_ not charmed; The [^f]babbler is no different. 

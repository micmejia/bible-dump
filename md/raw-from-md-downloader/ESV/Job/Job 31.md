...
then let me sow, and another eat, and let what grows for me[^a] be rooted out. 
...
(for from my youth the fatherless[^b] grew up with me as with a father, and from my mother's womb I guided the widow[^c]), 
...
if I have looked at the sun[^e] when it shone, or the moon moving in splendor, 
...
if I have concealed my transgressions as others do[^f] by hiding my iniquity in my heart, 

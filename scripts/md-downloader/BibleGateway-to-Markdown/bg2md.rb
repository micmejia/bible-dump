...
passage.gsub!(/<p.*?>/, "\n[NEWLINE]") # needs double quotes otherwise it doesn't turn this into newline
passage.gsub!(%r{</p>}, '')
...
passage.gsub!(/<i>/, '_')
passage.gsub!(%r{</i>}, '_')
passage.gsub!(%r{<br />}, "  \n[NEWLINE]") # use two trailling spaces to indicate line break but not paragraph break
